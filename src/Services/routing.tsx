...
import NewPassword from "./../Pages/User/Authentication/NewPassword/NewPassword";
import RegisterByLink from "../Pages/User/Authentication/RegisterByLink/RegisterByLink";
import VerifyEmail from "../Pages/User/Authentication/VerifyEmail/VerifyEmail";
    ...
    <AnimatePresence exitBeforeEnter>
      <BrowserRouter>
        <Routes>
          ...
          <Route path={"/RegisterByLink/:id"} element={<RegisterByLink />} />
